...
public class ModelManager implements Model {
    ...
    public ModelManager(ReadOnlyAddressBook addressBook, ReadOnlyUserPrefs userPrefs) {
        ...
        filteredAthletes = new FilteredList<>(this.addressBook.getPersonList());
    }
    ...
    public boolean hasPerson(Athlete athlete) {
        ...
        return addressBook.hasPerson(athlete);
    }
    ...
    public void setPerson(Athlete target, Athlete editedAthlete) {
        ...
        addressBook.setPerson(target, editedAthlete);
    }
